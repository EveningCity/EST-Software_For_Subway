...
class searched_dialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        self.searchedDialog.nameChinese.setText(Producer.ruleText.betterChinese(Search_Dialog.NAME[0]))
        self.searchedDialog.nameEnglish.setText(Producer.ruleText.betterEnglish(Search_Dialog.NAME[1]))
        self.subTitle(Search_Dialog.NAME)
        ...
        self.numberSet(Search_Dialog.NAME[0])
    ...
    def addRouteView(self):
        ...
        for servel_route in Producer.route.stationRouteServel(Search_Dialog.NAME[0]):
    ...
    def loadPic(self):
        ...
        for filename in os.listdir(Producer.route.resourcePath("data/stations/")):
            ...
            if filename.replace(".png", "").replace(".jpg", "").replace(".jpeg", "")  == Search_Dialog.NAME[1]:
                self.label = QLabel()
