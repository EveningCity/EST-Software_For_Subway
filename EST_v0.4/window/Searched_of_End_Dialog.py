...
class searched_end_dialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.searchedDialog = uic.loadUi(Producer.route.resourcePath("window/ui/end_dialog.ui"), self)
        ...
        self.searchedDialog.end.clicked.connect(self.startClicked)
    ...
    def startClicked(self):
        ...
        global STATION, START_DATA
        STATION = self.splitStringLine(Search_Plan_Dialog.NAME)[0]
        START_DATA = Search_Plan_Dialog.START_DATA
